...
//#define DP_CTRL_STAT   0x01        // Control & Status
//#define DP_WCR         0x01        // Wire Control Register (SW Only)
//#define DP_DLCR        0x01       // Data Link Control Register (Renamed WCR)
//#define DP_SELECT      0x02        // Select Register (JTAG R/W & SW W)
//#define DP_RESEND      0x02        // Resend (SW Read Only)
//#define DP_RDBUFF      0x03        // Read Buffer (Read Only)
